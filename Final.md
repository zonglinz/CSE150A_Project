...
**Key takeaway:** the refined TAN already doubles recall over naïve baselines while retaining > 0.9 accuracy. Structured feature discretisation and a KDB-3 upgrade are the most promising next steps for another 2-4 pp F1.  
